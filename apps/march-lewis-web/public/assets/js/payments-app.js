(function () {
  ...
  mount.innerHTML = `
    <section class="panel">
      <h2>March &amp; Lewis Payments + Wallet Prep</h2>
      <div class="grid two">
        <div class="card">
          <h3>Card Checkout</h3>
  ...
  const cardForm = document.getElementById('marchCardPaymentForm');
  const cryptoForm = document.getElementById('marchCryptoPaymentForm');
  const cardResult = document.getElementById('marchCardPaymentResult');
  const cryptoResult = document.getElementById('marchCryptoPaymentResult');
  const walletConfig = document.getElementById('marchWalletConfig');
